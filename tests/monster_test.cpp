...
TEST_F(MonsterTest, ConstructorAndDisplayStats) {
    ...
    EXPECT_TRUE(output.find("Healt: 50") != std::string::npos);
    EXPECT_TRUE(output.find("Attack: 10") != std::string::npos); 
    EXPECT_TRUE(output.find("Defence: 5") != std::string::npos); 
    EXPECT_TRUE(output.find("Special Ability: None") != std::string::npos);
}
...
TEST_F(MonsterTest, TakeDamage) {
    ...
    EXPECT_TRUE(output.find("Goblin: Taking damage!") != std::string::npos);
    EXPECT_TRUE(output.find("Remaining health: 40") != std::string::npos);
}
...
TEST_F(MonsterTest, TakeDamageToZero) {
    ...
    EXPECT_TRUE(output.find("Goblin: Taking damage!") != std::string::npos);
    EXPECT_TRUE(output.find("Remaining health: 0") != std::string::npos);
}
